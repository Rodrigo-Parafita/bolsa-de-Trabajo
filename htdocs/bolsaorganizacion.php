    ...
    <nav class="nav nav-pills flex-column">
        ...
        <div class="col-9">
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    // Consulta para obtener los datos de los alumnos (asegúrate de tener una tabla formcv en tu base de datos)
                    $sql = "SELECT NOM, APL, DES, ESC, PRO, PRM, IMG, CV, NOMCV, MIMECV FROM formcv";
