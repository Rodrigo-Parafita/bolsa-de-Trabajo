...
$sql = "SELECT NOM, APL, DES, ESC, PRO, PRM, IMG, CV, NOMCV, MIMECV FROM formcv WHERE ESC = 'E.E.S.T.N°6 Ferrocarriles Argentinos'";
...
if ($result->num_rows > 0) {
    ...
    echo "No se encontraron alumnos de la escuela 'E.E.S.T.N°6 Ferrocarriles Argentinos' en la base de datos.";
}
