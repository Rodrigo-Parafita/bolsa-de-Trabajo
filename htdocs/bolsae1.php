...
// Consulta para obtener los datos de los alumnos de la escuela "E.E.S.T.N°1 Nicolas Avellaneda"
$sql = "SELECT NOM, APL, DES, ESC, PRO, PRM, IMG, CV, NOMCV, MIMECV FROM formcv WHERE ESC = 'E.E.S.T.N°1 Nicolas Avellaneda'";
...
if ($result->num_rows > 0) {
    ...
    echo "No se encontraron alumnos de la escuela 'E.E.S.T.N°1 Nicolas Avellaneda' en la base de datos.";
}
