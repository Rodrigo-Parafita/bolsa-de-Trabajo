...
$sql = "SELECT NOM, APL, DES, ESC, PRO, PRM, IMG, CV, NOMCV, MIMECV FROM formcv WHERE ESC = 'E.E.S.T.N°3 Islas Malvinas'";
...
if ($result->num_rows > 0) {
    ...
    echo "No se encontraron alumnos de la escuela 'E.E.S.T.N°3 Islas Malvinas' en la base de datos.";
}
