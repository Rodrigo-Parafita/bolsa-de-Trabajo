...
<head>
    ...
    <link rel="shortcut icon" href="./IMG/logo-200.png">
              ...
              <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item">
                      ...
                      <hr>
                      <li class="nav-item">
                        <a class="nav-link" href="./cv.html">Subir Curriculum</a>
                      </li>
                      <hr>
...
<nav class="nav nav-pills flex-column">
    <a class="nav-link" href="./bolsa.php">Todos</a>
    <hr>
    ...
    <nav class="nav nav-pills flex-column">
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" id="schoolDropdown">
              <li><a class="dropdown-item" href="./bolsae1.php">E.E.S.T.N°1 Nicolas Avellaneda</a></li>
              <li><a class="dropdown-item" href="./bolsae2.php">E.E.S.T.N°2 DR. V. Alsina</a></li>
              <li><a class="dropdown-item" href="./bolsae3.php">E.E.S.T.N°3 Islas Malvinas</a></li>
              <li><a class="dropdown-item" href="./bolsae4.php">E.E.S.T.N°4 Martin Miguel de Güemes</a></li>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" id="professionDropdown">
              <li><a class="dropdown-item" href="./bolsaelectro.php">Electromecanica</a></li>
              <li><a class="dropdown-item" href="./bolsaorgani.php">Administracion de la Organizacion</a></li>
              <li><a class="dropdown-item" href="./bolsaalimentos.php">Tecnologia de los Alimentos</a></li>
              <li><a class="dropdown-item" href="./bolsainformatica.php">Informatica</a></li>
            ...
            <nav class="nav nav-pills flex-column">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" id="promedioDropdown">
                <li><a class="dropdown-item" href="./bolsap10.php">Promedio 10</a></li>
              <li><a class="dropdown-item" href="./bolsap9.php">Promedio 9</a></li>
              <li><a class="dropdown-item" href="./bolsap8.php">Promedio 8</a></li>
              <li><a class="dropdown-item" href="./bolsap7.php">Promedio 7</a></li>
        ...
        <div class="col-9">
                ...
                <?php
// Conecta a la base de datos (asegúrate de configurar correctamente la conexión a tu base de datos)
...
// Consulta para obtener los datos de los alumnos cuya profesión sea "Técnico en electromecánica"
$sql = "SELECT NOM, APL, DES, ESC, PRO, PRM, IMG, CV, NOMCV, MIMECV FROM formcv WHERE PRO = 'Técnico en administración de la organización'";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $promedio = $row["PRM"];
        $imagen = $row["IMG"];
        $contenido_pdf = $row["CV"];
        $nombre_archivo = $row["NOMCV"];
        $tipo_mime = $row["MIMECV"];

        // Mostrar los datos en el HTML
        echo '<div class="col">
                  <div class="card h-100">
                    <img src="data:image/jpeg;base64,' . base64_encode($imagen) . '" class="card-img-top" alt="Imagen de ' . $nombre . '">
                    <div class="card-body">
                        <h5 class="card-title">Nombre: ' . $nombre . '</h5>
                        <p class="card-text">Descripción: ' . $descripcion . '</p>
                        <p class="card-text">Escuela: ' . $escuela . '</p>
                        <p class="card-text">Profesión: ' . $profesion . '</p>
                        <p class="card-text">Promedio: ' . $promedio . '</p>
                    </div>
                    <div class="card-footer">
                        <a class="btn btn-primary" href="data:' . $tipo_mime . ';base64,' . base64_encode($contenido_pdf) . '" download="' . $nombre . '">Descargar CV</a><br>
                    </div>
                  </div>
                </div>';
    }
} else {
    echo "No se encontraron alumnos en la base de datos con la profesión 'Técnico en administración de la organización'.";
}
...
?>
    ...
    <script>
        // Agrega este script al final del body para asegurarte de que el DOM se haya cargado
        
        // Obtén referencias a los menús desplegables
        const schoolDropdown = document.querySelector("#schoolDropdown");
        const professionDropdown = document.querySelector("#professionDropdown");
        const promedioDropdown = document.querySelector("#promedioDropdown");
        
        // Agrega manejadores de eventos para los menús desplegables
        schoolDropdown.addEventListener("change", filterResults);
        professionDropdown.addEventListener("change", filterResults);
        promedioDropdown.addEventListener("change", filterResults);
        
        // Obtén todos los elementos de resultados
        ...
        function filterResults() {
            ...
            const selectedPromedio = promedioDropdown.value;
            
            results.forEach(result => {
                const school = result.dataset.school;
                const profession = result.dataset.profession;
                const promedio = result.dataset.promedio;
                
                // Comprueba si el resultado cumple con los filtros seleccionados
                const schoolMatch = selectedSchool === "All" || selectedSchool === school;
                const professionMatch = selectedProfession === "All" || selectedProfession === profession;
                const promedioMatch = selectedPromedio === "All" || selectedPromedio === promedio;
                
                // Muestra u oculta el resultado según los filtros
                if (schoolMatch && professionMatch && promedioMatch) {
