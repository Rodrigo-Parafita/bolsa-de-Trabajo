...
// Consulta para obtener los datos de los alumnos con promedio igual a 10
$sql = "SELECT NOM, APL, DES, ESC, PRO, PRM, IMG, CV, NOMCV, MIMECV FROM formcv WHERE PRM = 10";
...
if ($result->num_rows > 0) {
    ...
    echo "No se encontraron alumnos con promedio 10 en la base de datos.";
}
