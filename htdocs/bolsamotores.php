...
$sql = "SELECT NOM, APL, DES, ESC, PRO, PRM, IMG, CV, NOMCV, MIMECV FROM formcv WHERE PRO = 'Técnico en automotores'";
...
if ($result->num_rows > 0) {
    ...
    echo "No se encontraron alumnos en la base de datos con la profesión 'Técnico en automotores'.";
}
