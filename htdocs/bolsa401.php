...
$sql = "SELECT NOM, APL, DES, ESC, PRO, PRM, IMG, CV, NOMCV, MIMECV FROM formcv WHERE ESC = 'C.F.P. N° 401'";
...
if ($result->num_rows > 0) {
    ...
    echo "No se encontraron alumnos de la escuela 'C.F.P. N° 401' en la base de datos.";
}
